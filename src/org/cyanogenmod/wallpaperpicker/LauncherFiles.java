...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "org.cyanogenmod.wallpaperpicker.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "org.cyanogenmod.wallpaperpicker.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "org.cyanogenmod.wallpaperpicker.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "org.cyanogenmod.wallpaperpicker.compat.PackageInstallerCompatV16.queue"));
}
